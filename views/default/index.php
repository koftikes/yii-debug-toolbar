            ...
            <table class="table table-condensed table-bordered table-striped table-hover table-filtered"
                ...
                <?php foreach ($manifest as $tag => $data): ?>
                    <tr>
                        ...
                        <td><?php echo CHtml::link(\date('Y-m-d h:i:s', $data['time']),
                                ['view', 'tag' => $tag, 'panel' => 'request']); ?></td>
                        ...
                        <td style="word-break:break-all;">
                            ...
                            <?php echo CHtml::link('<i class="icon-share"></i>', $data['url'],
                                ['class' => 'share', 'target' => 'blank']); ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
