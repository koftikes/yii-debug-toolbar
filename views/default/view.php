...
<div class="default-view">
    <?php $this->renderPartial('_toolbar', ['panels' => $panels]); ?>
        ...
        <div class="row-fluid">
            <div class="span2">
                <ul class="nav nav-pills nav-stacked">
                    ...
                    foreach ($panels as $id => $panel) {
                        $link = CHtml::link(CHtml::encode($panel->getName()),
                            ['view', 'tag' => $tag, 'panel' => $id]);
                        echo CHtml::tag('li', ['class' => $panel === $activePanel ? 'active' : null], $link);
                    }
                    ?>
                </ul>
            </div><!--/span-->
            <div class="span10">
                <div class="callout alert alert-info">
                    <div class="btn-group">
                        <?php echo CHtml::link('All', ['index'], ['class' => 'btn']); ?>
                        <?php echo CHtml::link('Latest', ['view', 'panel' => $activePanel->id],
                            ['class' => 'btn']); ?>
